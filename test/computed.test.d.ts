...
declare type ComputedComponent = wxNS.Component.ComputedConstructor
declare type IAnyObject = wxNS.IAnyObject
declare type ComputedOptions = wxNS.Component.ComputedOptions<
  IAnyObject,
  IAnyObject,
  IAnyObject,
  IAnyObject
